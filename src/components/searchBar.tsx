...
const SearchBar = () => {
  ...
  return (
    <div className="mb-3 w-64 sm:w-96 md:w-96 flex items-start sm:flex">
      <div className="relative mb-4 flex w-full flex-wrap sm:flex-wrap items-stretch sm:items-stretch">
        <input
          type="search"
