...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\Lahiruni\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.351\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20df39be94bf621c9d16a3UUgKDUxVAwdTBVdRBFoIVAUHUVcB'}); } catch(cjsError) { try { import('file:///c:/Users/Lahiruni/.vscode/extensions/wallabyjs.console-ninja-1.0.351/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20df39be94bf621c9d16a3UUgKDUxVAwdTBVdRBFoIVAUHUVcB'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
