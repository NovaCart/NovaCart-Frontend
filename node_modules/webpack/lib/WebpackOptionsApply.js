...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\Lahiruni\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.350\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '204fe3d6ca2698bd0edaf9HkhPHU4MVwIDAltZUVUBUgFSXwpS'}); } catch(cjsError) { try { import('file:///c:/Users/Lahiruni/.vscode/extensions/wallabyjs.console-ninja-1.0.350/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '204fe3d6ca2698bd0edaf9HkhPHU4MVwIDAltZUVUBUgFSXwpS'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
